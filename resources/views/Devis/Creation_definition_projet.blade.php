        ...
        <div class="p-4">
            <form action="/devis2">
                <div class="form-group">
                    ...
                    <div id="choixClient" class="buttons_ref_client">
                        <a href="#" class="btn btn-outline-primary btn-lg btn-block" style="width : 35%; border: solid 2px" role="button">Client
                            existant</a>
                        <a href="#" class="btn btn-outline-secondary btn-lg" style="width : 35%; border : solid 2px"   role="button">Nouveau
                            client</a>
                    </div>
                </div>
